# Generated by Powerlevel10k configuration wizard on 2023-12-16 at 18:22 EST.
...
# full frame, dark-ornaments, compact, many icons, fluent, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=005
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=003
